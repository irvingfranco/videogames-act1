...
public class hacker : MonoBehaviour {
    ...
    string[] level4Passwords = { "chandler", "monica", "rachel", "ross" };
    ...
    void ShowMainMenu()
    {
        ...
        Terminal.WriteLine("did you like friends pess 4");
...
|_| |_||___)\__,_|
            ...
            case 4:
                Terminal.WriteLine("monica would be proud!");
                Terminal.WriteLine(@"
  █▀▀ █▀▄ ▀█▀ █▀▀ █▄░█ █▀▄ ▄▀▀
█▀▀ █▀▄ ░█░ █▀▀ █▀██ █░█ ░▀▄
▀░░ ▀░▀ ▀▀▀ ▀▀▀ ▀░░▀ ▀▀░ ▀▀░ 
    ...
    private void SetRandomPassword()
    {
        ...
        switch (level)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                password = level4Passwords[UnityEngine.Random.Range(0, level3Passwords.Length)];
                break;
            default:
